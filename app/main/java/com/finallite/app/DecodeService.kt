...
import com.com.finallite.audio.AudioDecodingListener
import com.finallite.ARApplication
import com.finallite.AppConstants
import com.finallite.AppConstants.DECODE_DURATION
import com.finallite.AppConstants.PENDING_INTENT_FLAGS
...
import com.finallite.util.isUsingNightModeResources
...
class DecodeService : Service() {
	...
	companion object {
		...
		private const val CHANNEL_ID = "com.finallite.Decode.Notification"
	...
	private fun startDecode(id: Int) {
		...
		processingTasks.postRunnable {
			...
			if (rec != null && rec.duration / 1000 < DECODE_DURATION) {
				waveformVisualization.decodeRecordWaveform(rec.path, object :
