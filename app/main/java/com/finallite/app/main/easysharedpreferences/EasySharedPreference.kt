package com.finallite.app.main.easysharedpreferences
...
class EasySharedPreference {
    ...
    companion object {
        ...
        @SuppressLint("KotlinNullnessAnnotation")
        @Nullable
        fun getStringSet(key: String, @SuppressLint("KotlinNullnessAnnotation") @Nullable defValue: Set<String>): Set<String>? {
            checkForNullKey(key)
        ...
        @Nullable
        fun putStringSet(key: String, @SuppressLint("KotlinNullnessAnnotation") @Nullable value: Set<String>) {
            checkForNullKey(key)
