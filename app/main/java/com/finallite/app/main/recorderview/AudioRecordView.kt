...
import com.finallite.ColorMap.KEY_IMAGE2
import com.finallite.R
import com.finallite.app.main.easysharedpreferences.EasySharedPreference
import com.finallite.databinding.ViewAudioRecordBinding
...
class AudioRecordView : FrameLayout {
    ...
    var micIcon: Int = R.drawable.ic_record_mic_black
        set(value) {
            ...
            val image2 = EasySharedPreference.getInt(KEY_IMAGE2, R.color.brown_100)
            binding.recordIb.setBackgroundResource(image2)
        }
