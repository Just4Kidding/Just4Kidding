package com.finallite.app.main.finestwebview
...
import com.finallite.*
import com.finallite.app.RecordingService
import com.finallite.app.lostrecords.RecordItem
import com.finallite.app.main.MainContract
import com.finallite.app.main.easysharedpreferences.EasySharedPreference
import com.finallite.app.main.finestwebview.enums.ProgressBarPosition
import com.finallite.app.main.finestwebview.listeners.BroadCastManager.Companion.onDownloadStart
import com.finallite.app.main.finestwebview.listeners.BroadCastManager.Companion.onLoadResource
import com.finallite.app.main.finestwebview.listeners.BroadCastManager.Companion.onPageCommitVisible
import com.finallite.app.main.finestwebview.listeners.BroadCastManager.Companion.onPageFinished
import com.finallite.app.main.finestwebview.listeners.BroadCastManager.Companion.onPageStarted
import com.finallite.app.main.finestwebview.listeners.BroadCastManager.Companion.onProgressChanged
import com.finallite.app.main.finestwebview.listeners.BroadCastManager.Companion.onReceivedTitle
import com.finallite.app.main.finestwebview.listeners.BroadCastManager.Companion.onReceivedTouchIconUrl
import com.finallite.app.main.finestwebview.listeners.BroadCastManager.Companion.unregister
import com.finallite.app.main.finestwebview.utils.BitmapUtil.getColoredBitmap
import com.finallite.app.main.finestwebview.utils.BitmapUtil.getGradientBitmap
import com.finallite.app.main.finestwebview.utils.ColorUtil.disableColor
import com.finallite.app.main.finestwebview.utils.DisplayUtil.getHeight
import com.finallite.app.main.finestwebview.utils.DisplayUtil.getStatusBarHeight
import com.finallite.app.main.finestwebview.utils.DisplayUtil.getWidth
import com.finallite.app.main.finestwebview.utils.TypefaceUtil
import com.finallite.app.main.finestwebview.utils.UnitConverter.dpToPx
import com.finallite.app.main.finestwebview.utils.UrlParser.getHost
import com.finallite.app.main.finestwebview.views.ShadowLayout
import com.finallite.app.main.recorderview.AudioRecordView
import com.finallite.app.trash.TrashContract
import com.finallite.data.FileRepository
import com.finallite.exception.CantCreateFileException
import com.finallite.util.AndroidUtils
import com.google.android.material.appbar.AppBarLayout
import com.google.android.material.snackbar.Snackbar

class FinestWebViewActivity : LocalizationActivity(), AppBarLayout.OnOffsetChangedListener,
    View.OnClickListener, AudioRecordView.Callback {
    ...
    protected var record_view: AudioRecordView? = null
    ...
    protected fun bindViews() {
        ...
        record_view = findViewById< View>(R.id.record_view) as AudioRecordView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val color = EasySharedPreference.getInt(KEY_COLOR, R.color.brown_100)

        record_view?.apply {
            activity = this@FinestWebViewActivity
            callback = this@FinestWebViewActivity
            micIcon = R.drawable.ic_record_mic_white
            micHintEnable = true
            micHintText = resources.getString(R.string.hold_to_record_audio)
            micHintColor = ContextCompat.getColor(context, R.color.white)
            micHintBg =  R.drawable.bg_record_tip
            blinkColor = ContextCompat.getColor(context, R.color.red_600)
            circleColor = ContextCompat.getColor(context, color)
            cancelIconColor = ContextCompat.getColor(context, R.color.red_600)
            slideCancelText = resources.getString(R.string.slide_to_cancel)
